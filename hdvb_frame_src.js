!function() {
    ...
    var actual = 'https://vid' + Date.now() + '.vb17101tesswalton.pw',
        re = '^https?:\\/\\/(vii?dd?\\d*.)?{DOMAIN}',
        https = ['makrohd.(info|com|net)', 'hdvb.(cc|xyz)', 'videolishd.(net|com)',  'farsihd.(info|pw)', 'tehranvd.(ru|su|net|com|org|pw|biz)', 'my\-serials.(info)', 'vb17102bernardjordan.(pw)', 'vb17100astridcoleman.(pw)', 'vb17101tesswalton.(pw)'],
        list = [], delay = 200;
